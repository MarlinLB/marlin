...
Include the affected component (datapath / loader / control plane / deploy config), a commit or
version, reproduction steps, and impact.

## Scope

In scope: `data-plane/` (XDP datapath), `loader/` (the data-plane loader), `control-plane/`
(C#), `deploy/` (unit and config files).
